...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  bias=bias, vocab_size=None, dropout=dropout, attn=attn,
                  kappa=kappa, alpha=alpha, local_window=local_window) # start with model_args from command line
...
if wandb_log and master_process:
    import wandb
    wandb.init(project=wandb_project, name=f"{attn}-{kappa}-{alpha}-{local_window}", config=config)
